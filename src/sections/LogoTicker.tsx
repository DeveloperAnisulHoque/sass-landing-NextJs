...
export const LogoTicker = () => {
  return <section className='py-8 md:py-11 bg-white'>
    <div className='container'>
      <div className='flex overflow-hidden [mask-image:linear-gradient(to_right,transparent,black,transparent)]'>
        ...
        >
          ...
          <Image src={clestialLogo} alt='Celestial Logo' className='logo-ticker-image' />
          <Image src={pulseLogo} alt='Puse Logo' className='logo-ticker-image' />
