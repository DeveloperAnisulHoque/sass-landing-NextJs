           ...
           <div className="container">
            <div className="md:flex items-center">  
                      <div className='md:w-[478px]'> 
                            ...
                            <p className="text-xl  text-[#010D3E] tracking-tight mt-6">Celebrate the joy of accomplishment with and app designed to  tracking your progress, motivate your efforts , and clebrate your success</p>
                      ...
                      <div className='mt-20 md:mt-0 md:h-[648px] md:flex-1 relative'>
                       ...
                       src={cylinderImage.src} alt='Cylinder image' />
